                    ...
                    return (
                      <React.Fragment key={task.id}>
                        <DropZone
                          ...
                          onDrop={handleDrop}
                        />
                        <Task key={task.id} laneId={data.id} data={task} handleDrop={handleDrop} path={currentPath} setTaskModalRes={setTaskModalRes} completeTaskOnClick={props.completeTaskOnClick}/>
                      </React.Fragment>
                    )
                })
              }
